		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<form action="/orders/delete.do" method="post">
						<!-- 数据表格 -->
						<div class="table-box">
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findOne.do?id=${orders.id}'">详情</button>
